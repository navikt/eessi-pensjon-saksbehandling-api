...
Denne klassen er utkommentert fordi vi ikke bruker den pr. dags dato.
I tillegg finnes ikke 'no.nav.meldinger.virksomhet:nav-virksomhet-varsel-v1-meldingsdefinisjon:1.1.1:jaxb' på github packages pr. dags dato.

Det har også i ettertid kommet en ny tjeneste på kafka som overtar for dette:
https://github.com/navikt/brukernotifikasjon-schemas
